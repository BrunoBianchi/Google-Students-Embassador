...
const PublicProfile = ({ userId }: { userId: string }) => {
  ...
  return <main className="min-h-screen bg-[#F8FAFE] text-[#1e293b]">
    ...
    <div className="mx-auto max-w-5xl px-4 py-6 sm:px-8 sm:py-9">
      ...
      <section className="mt-6 grid gap-4 sm:grid-cols-3"><Stat icon={Sparkles} label="Selos" value={stats.badgesEarned} color="blue" /><Stat icon={CalendarDays} label="Eventos criados" value={stats.eventsCreated} color="red" /><Stat icon={UsersRound} label="Grupos criados" value={stats.groupsCreated} color="green" /></section>
